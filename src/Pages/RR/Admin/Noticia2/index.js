...
import { Paper, Divider, CardActionArea, TextareaAutosize, Input, Dialog, DialogTitle, CircularProgress, Typography } from '@material-ui/core';
...
class Noticia2 extends Component {
    ...
    async componentDidMount() {
        ...
        //const noticia = await (await this.api.get('noticia/' + this.state.idnoticia)).data;
        //console.log(noticia)
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Noticia2));